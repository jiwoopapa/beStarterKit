...
Spring Boot + Kotlin REST API Controller를 분석하여 MockMvc 기반 통합 테스트를 자동으로 생성
...
1. **Controller 선택**
   - 사용자가 지정한 Controller 또는 전체 Controller 자동 탐지
...
📂 {Controller명} 분석 완료
   ├─ {HTTP메서드} {경로} → {N}개 테스트 생성
   └─ ...

✅ 생성된 테스트 파일
   📄 src/test/kotlin/.../{Controller}Test.kt
